...
class Element extends ChemicalElement with CompoundUnit, EquationUnit {
    ...
    MatterPhase stpPhase, int number, period, int row, column, List<int> shells,
    num atomicMass, num molecularDensity, num heatCapacity, num meltingPoint, num boilingPoint
  ): super(
